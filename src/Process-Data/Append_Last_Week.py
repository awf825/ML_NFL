...
games_con = sqlite3.connect("/Users/aidenflynn/ML_Python/python-nfl/Data/games.sqlite")
...
for year in years:
    ...
    # df.to_sql(f"games_2003_2024", games_con, if_exists="replace")
    print(f'Appending week {args.week} games to datasets now...')
    df.to_sql(f"games_2013-{year}", games_con, if_exists="append")
    df.to_sql(f"games_2003-{year}", games_con, if_exists="append")
