...
from src.Utils.emegergencygames import manual_games
    ...
    def get_odds(self):
        ...
        for game in self.games:
            ...
            dict_res[home_team_name + ':' + away_team_name] =  { 
                ...
                home_team_name: { 
                    'money_line_odds': money_line_home_value,
                    'spread': spread_home_value
                }, 
                away_team_name: { 
                    'money_line_odds': money_line_away_value,
                    'spread': spread_away_value
                }
            }
        return dict_res