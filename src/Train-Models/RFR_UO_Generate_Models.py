...
for dataset in datasets:
    ...
    print('Saving model...')
    with open(
        f'/Users/aidenflynn/ML_Python/python-nfl/Models/RF/Regressor/UO/{year}_{month}_{day}_{round(cross_val*100,1)}_R2_{round(r2*100, 1)}_{dataset}.obj', 
        'wb'
    ) as f:
        dill.dump(rfc, f)

    print(f'Completed UO evaluation of {dataset}!')
    print('\n')